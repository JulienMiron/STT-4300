...
resultats <- map_dfr(1:(n - 1), function(k) {
  # Groupe x = 1 : k succès sur n (k croît jusqu'à la séparation complète)
  y1 <- c(rep(1, k), rep(0, n - k))
  # Groupe x = 0 : référence, toujours 50 % de succès
  ...
  wald_z2  <- (beta_hat / et_hat)^2          # statistique de Wald au carré (échelle khi-carré à 1 ddl)
