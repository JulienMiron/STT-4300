...
Les intervalles de confiance et tests concernant les $\beta_j$ sont obtenus par la méthode de **Wald**. Un intervalle de confiance à $100\times(1-\alpha)%$ pour $\beta_j$ est
